...
/** 404 — recurso não encontrado ({@code CUSTOMER_NOT_FOUND}, {@code PRODUCT_NOT_LINKED}…). */
public class NotFoundException extends BfocusException {
     ...
     */
    public NotFoundException(String code, int status, String message, String requestId, Map<String, String> validation,
